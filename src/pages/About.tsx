...
import { LOL_SEARCH_URL, POKEMON_SEARCH_URL, TWITCH_URL } from '../constants';
  ...
  return (
    <main className="wrap interior" id="main-content">
      ...
      <section className="about-grid" aria-label="About CryptonicFlux">
        ...
        <article><Gamepad2 aria-hidden="true" /><span>03</span><h2>Player tools</h2><p>Practical side projects such as LoL Search and Pokémon Search, made to help players get into the game faster.</p></article>
      </section>
      ...
      <section className="about-connect" aria-labelledby="connect-title">
        ...
        <div className="connect-actions">
          ...
          <a className="button button-tool" href={LOL_SEARCH_URL} target="_blank" rel="noopener noreferrer">LoL Search <ArrowUpRight aria-hidden="true" size={17} /></a>
          <a className="button button-tool" href={POKEMON_SEARCH_URL} target="_blank" rel="noopener noreferrer">Pokémon Search <ArrowUpRight aria-hidden="true" size={17} /></a>
          <SocialLinks />
        </div>
      </section>
    </main>
